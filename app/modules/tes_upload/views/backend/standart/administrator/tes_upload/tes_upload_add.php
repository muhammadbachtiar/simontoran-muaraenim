...
<section class="content-header">
    <h1>
        Tes Upload        <small><?= cclang('new', ['Tes Upload']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Tes Upload']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/tes_upload/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            ...
            $('.message').fadeIn();
            resetForm();
            $('#tes_upload_lampiran_galery').find('li').each(function() {
               $('#tes_upload_lampiran_galery').fineUploader('deleteFile', $(this).attr('qq-file-id'));
            });
