...
<section class="content-header">
    <h1>
        Gaji       <small><?= cclang('new', ['Gaji']); ?> </small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class=""><a  href="<?= site_url('administrator/gaji'); ?>">Gaji</a></li>
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <!-- /.widget-user-image -->
                            <h3 class="widget-user-username">Gaji</h3>
                            <h5 class="widget-user-desc"><?= cclang('new', ['Gaji']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        ?>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="bagian" id="bagian" data-placeholder="Select Bagian" >
                                    ...
                                    <?php
                                    $this->db->where('id','11');
                                    $bagians = $this->db->get('masterbagian')->result();
                                    
                                    ?>
                                    <?php foreach ($bagians as $row): ?>
                                    <option value="<?= $row->id ?>" selected ><?= $row->nama_bagian; ?></option>
                                    <?php endforeach; ?>  
                                </select>
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
          ...
          function(isConfirm){
            if (isConfirm) {
              window.location.href = BASE_URL + 'administrator/gaji';
            }
          });
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/gaji/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
