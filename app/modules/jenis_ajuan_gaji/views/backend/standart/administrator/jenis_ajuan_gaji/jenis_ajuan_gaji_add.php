...
<section class="content-header">
    <h1>
        Jenis Ajuan Gaji        <small><?= cclang('new', ['Jenis Ajuan Gaji']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Jenis Ajuan Gaji']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        ?>
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="jenis_ajuan_gaji" id="jenis_ajuan_gaji" placeholder="Jenis Ajuan Gaji" value="LS - Gaji ">
                            ...
                            <div class="col-sm-8">
                                    ...
                                    <label>
                                    <input type="radio" class="flat-red" name="jenis_gaji" value="asn"> asn                                    </label>
                                    </div>
                                    <div class="col-md-3 padding-left-0">
                                    <label>
                                    <input type="radio" class="flat-red" name="jenis_gaji" value="kdh"> kdh                                    </label>
                                    </div>
                                    </select>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/jenis_ajuan_gaji/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
