       ...
       .border_bawah {
        ...
        @media print {
            ...
            #cetak {
                border: 1px solid #ccc;
                padding: 20px;
                transform: scale(0.8); /* Skalakan menjadi 80% */
                        ...
                        <div class="box box-widget widget-user-2">
                            <div class="widget-user-header">
                                ...
                                <div class="widget-user-image">
                                    <a href="<?= site_url('administrator/gaji')?>" class="btn btn-warning"><i class="fa fa-rotate-left"></i> Kembali</a>
                                </div>
                              <br>
                                <div id="cetak">
                                    <div class="gaji"><?= $bendel_pertama[0]->nama_ceklist ?></div>
