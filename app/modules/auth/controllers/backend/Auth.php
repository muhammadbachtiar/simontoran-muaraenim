...
class Auth extends Admin
{
	...
	public function login()
	{
		...
		$this->template->build('backend/standart/administrator/login/index', $data);
	}
	...
	public function register()
	{
		...
		if ($this->form_validation->run()) {
			...
			if ($save_user) {
				...
				redirect('administrator/login/index', 'refresh');
			} else {
	...
	{
		$this->aauth->logout();
		// redirect('https://perencanaan.blitarkab.go.id/simontoran');
		redirect(base_url());
	}
