...
<section class="content-header">
    <h1>
        Pemindahbukuan (PB)        <small><?= cclang('new', ['Pemindahbukuan (PB)']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Pemindahbukuan (PB)']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_setorpb', 
                        ...
                        ?>
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="tanggal_pb"  placeholder="Tanggal Pb" id="tanggal_pb">
                            </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/setorpb/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
