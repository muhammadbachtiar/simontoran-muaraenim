...
<section class="content-header">
    <h1>
        Bagian        <small>Edit Bagian</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Bagian</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/masterbagian/edit_save/'.$this->uri->segment(4)), [
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_bagian" id="nama_bagian" placeholder="Nama Bagian" value="<?= set_value('nama_bagian', $masterbagian->nama_bagian); ?>">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="bpp" id="bpp" data-placeholder="Select Bpp" >
                                    ...
                                    <option <?=  $row->id ==  $masterbagian->bpp ? 'selected' : ''; ?> value="<?= $row->id ?>"><?= $row->full_name; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="pptk[]" id="pptk" data-placeholder="Select Pptk" multiple >
                                    ...
                                    <option <?=  in_array($row->id, explode(',', $masterbagian->pptk)) ? 'selected' : ''; ?> value="<?= $row->id ?>"><?= $row->full_name; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="verifikator" id="verifikator" data-placeholder="Select Verifikator" >
                                    ...
                                    <option <?=  $row->id ==  $masterbagian->verifikator ? 'selected' : ''; ?> value="<?= $row->id ?>"><?= $row->full_name; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="verifikator2" id="verifikator2" data-placeholder="Select Verifikator2" >
                                    ...
                                    <option <?=  $row->id ==  $masterbagian->verifikator2 ? 'selected' : ''; ?> value="<?= $row->id ?>"><?= $row->full_name; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_masterbagian.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id = $('#masterbagian_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
