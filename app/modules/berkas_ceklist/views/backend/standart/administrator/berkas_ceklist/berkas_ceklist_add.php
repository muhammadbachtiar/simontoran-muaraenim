...
<section class="content-header">
    <h1>
        Berkas Ceklist        <small><?= cclang('new', ['Berkas Ceklist']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Berkas Ceklist']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        ?>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="jenis_ceklist" id="jenis_ceklist" data-placeholder="Select Jenis Ceklist" >
                                    ...
                                    <option value="<?= $row->id ?>"><?= $row->nama_ceklist; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/berkas_ceklist/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
