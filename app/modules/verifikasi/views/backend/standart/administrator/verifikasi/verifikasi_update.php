            ...
            <div class="box box-warning">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/verifikasi/edit_save/'.$this->uri->segment(4)), [
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control" name="tanggal" id="tanggal" placeholder="Tanggal" value="<?= set_value('', $verifikasi->tanggal); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <textarea id="uraian" name="uraian" rows="5" class="textarea form-control"><?= set_value('uraian', $verifikasi->uraian); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="dicukupi" id="dicukupi" data-placeholder="Select Dicukupi" >
                                    <option value=""></option>
                                    <option <?= $verifikasi->dicukupi == "Ya" ? 'selected' :''; ?> value="Ya">Ya</option>
                                    <option <?= $verifikasi->dicukupi == "Belum" ? 'selected' :''; ?> value="Belum">Belum</option>
                                    </select>
                                <small class="info help-block">
                                </small>
                            </div>
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
          ...
          function(isConfirm){
            if (isConfirm) {
              window.location.href = BASE_URL + 'administrator/verifikasi';
            }
          });
