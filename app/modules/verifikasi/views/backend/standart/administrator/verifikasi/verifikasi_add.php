...
<section class="content-header">
    ...
    <h1>
        Verifikasi SPJ        <small><?= cclang('new', ['Verifikasi SPJ']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Verifikasi SPJ']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        ?>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="spj" id="spj" data-placeholder="Select Spj" >
                                    ...
                                    <?php if($row->id ==$id): ?>
                                    <option value="<?= $row->id ?>" selected><?= $row->no_spj; ?></option>
                                    <?php  endif; ?>
                                    <?php endforeach; ?>  
                                </select>
                        ...
                        <!--    </label>-->
                        <!--    <div class="col-sm-8">-->
                        <!--        <input type="text" class="form-control" name="verifikator" id="verifikator" placeholder="Verifikator" value="<?= $this->aauth->get_user_id() ?>">-->
                        <!--        <small class="info help-block">-->
                        <!--        </small>-->
                        <!--    </div>-->
                        <!--</div>-->
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
          ...
          function(isConfirm){
            if (isConfirm) {
              window.location.href = BASE_URL + 'administrator/verifikasi/index?bulk=&q=<?= $id?>&f=spj&sbtn=Apply';
            }
          });
