...
// --- Bantuan (specific first) ---
$route['administrator/bantuan/view/(:num)']
    = 'bantuan/backend/bantuan/view/$1';

$route['administrator/bantuan/comment_save/(:num)']
    = 'bantuan/backend/bantuan/comment_save/$1';

$route['administrator/bantuan/comment_delete/(:num)/(:num)']
    = 'bantuan/backend/bantuan/comment_delete/$1/$2';
...
$route['api/(:any)/(:any)/(:any)/(:any)'] = '$1/api/$1/$2/$3/$4';
