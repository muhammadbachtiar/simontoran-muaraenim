                     ...
                     {php_open_tag} foreach($<?= $table_name; ?>s as $<?= $table_name; ?>): {php_close_tag}
                        <tr>
                           ...
                           if (!$this->crud_builder->getFieldFile($field) AND !$this->crud_builder->getFieldFileMultiple($field) AND !$relation){ 
                            ?><td>{php_open_tag_echo} _ent($<?= $table_name; ?>-><?= $field; ?>); {php_close_tag}</td><?php } elseif ($is_relation_multiple){
                            ...
                            ?><td>
                              ...
                              {php_open_tag} if (!empty($file)): {php_close_tag}
                                ...
                                {php_open_tag} else: {php_close_tag}
                                  <a href="{php_open_tag_echo} BASE_URL . 'uploads/<?= $table_name; ?>/' . $file; {php_close_tag}">
                           ...
                           <?php } else { 
                            ?><td>
                              {php_open_tag} if (!empty($<?= $table_name; ?>-><?= $field; ?>)): {php_close_tag}
                                ...
                                {php_open_tag} else: {php_close_tag}
                                  <a href="{php_open_tag_echo} BASE_URL . 'uploads/<?= $table_name; ?>/' . $<?= $table_name; ?>-><?= $field;?>; {php_close_tag}">
                           ...
                           ?><?php if ($primary_key): ?><td width="200">
                              ...
                              <?php if ($this->input->post('read')) { ?>
                                {php_open_tag} is_allowed('<?= $table_name; ?>_view', function() use ($<?= $table_name; ?>){{php_close_tag}
                                 <a href="{php_open_tag_echo} site_url('administrator/<?= $table_name; ?>/single_pdf/' .${table_name}->{primary_key}); {php_close_tag}" class="label-default"><i class="fa fa-file-pdf-o"></i> {php_open_tag_echo} cclang('PDF') {php_close_tag}
