...
<div class="wrapper" id="app">
  ...
  <header class="main-header">
    ...
    <a href="<?= site_url('/'); ?>" class="logo">
      <span class="logo-mini"><b><img src="<?= base_url() ?>uploads/setting/<?=  get_option('logo')?>" height="40px"></b></span>
